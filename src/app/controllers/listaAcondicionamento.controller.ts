...
export async function obterListaAcondicionamento(req: Request, res: Response): Promise<void> {
  ...
  try {
    const url = `https://mtr.fepam.rs.gov.br/mtrservice/retornaListaAcondicionamento/${login}/${senha}/${cnp}`;
