...
export async function obterListaClasse(req: Request, res: Response): Promise<void> {
  ...
  try {
    const url = `https://mtr.fepam.rs.gov.br/mtrservice/retornaListaClasse/${login}/${senha}/${cnp}`;
