...
export async function obterListaEstadoFisico(req: Request, res: Response): Promise<void> {
  ...
  try {
    const url = `https://mtr.fepam.rs.gov.br/mtrservice/retornaListaEstadoFisico/${login}/${senha}/${cnp}`;
