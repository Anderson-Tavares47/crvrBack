...
export async function obterListaResiduo(req: Request, res: Response): Promise<void> {
  ...
  try {
    const url = `https://mtr.fepam.rs.gov.br/mtrservice/retornaListaResiduo/${login}/${senha}/${cnp}`;
