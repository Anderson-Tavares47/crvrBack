...
export async function obterListaUnidades(req: Request, res: Response): Promise<void> {
  ...
  try {
    const url = `https://mtr.fepam.rs.gov.br/mtrservice/retornaListaUnidade/${login}/${senha}/${cnp}`;
